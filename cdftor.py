...
from mrFD
''')
print("\033[1;40;31m This Tool is Developed by [Omar] xit eXploiter !\n")
...
os.system("service tor start")
x = input("[+] time to change CDFTOR Ip in Sec [type=60] >> ")
lin = input("[+] How many times do you want to change your IP? enter to infinite CDFtor IP change] >> ") or "0"
